...
### Changed
- **Navegação**: O rótulo nos componentes de `Header` foi alterado para "Performance Operacional" para detalhar o contexto do dashboard, enquanto a `Sidebar` mantém o rótulo principal como "Dashboards".

## [2.3.2] - 2026-03-11

### Changed
- **Navegação**: O rótulo "Overview" foi alterado para "Dashboards" na Sidebar e nos componentes de Header de todos os módulos de painéis analíticos para maior clareza semântica.
